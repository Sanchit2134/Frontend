...
const Collection = () => {
  ...
  useEffect(() => {
    applyFilter();
  }, [category, subCategory, search, searchShow])
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        ...
        {/* Category Options */}
        <div className={`border border-gray-500 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`} src={assets.dropdown_icon}>
          <p className='mb-3 text-sm font-medium'>CATEGORIES</p>
          <div className='flex flex-col gap-2 tx-sm font-light text-gray-500'>
